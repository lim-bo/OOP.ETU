...
Q_CONSTINIT static const qt_meta_stringdata_CLASSApplicationENDCLASS_t qt_meta_stringdata_CLASSApplicationENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 13),  // "displayAnswer"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 14),  // "toCommunicator"
        QT_MOC_LITERAL(42, 16)   // "fromCommunicator"
    },
    "Application",
    "displayAnswer",
    "",
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->displayAnswer((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->toCommunicator((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 2: _t->fromCommunicator((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Application::*)(QString );
            if (_t _q_method = &Application::displayAnswer; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Application::displayAnswer(QString _t1)
{
